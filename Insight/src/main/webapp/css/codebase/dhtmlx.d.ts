...
declare class dhtmlXGridObject {
	...
	cells(row_id:string|number, col:number):any;
	...
	filterBy(column:number, value:string|any, preserve:boolean):void;
	filterByAll():void;
	...
	makeFilter(id:string|number|HTMLElement, column:number, preserve:boolean):void;
